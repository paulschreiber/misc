...
if ( !defined('COUNTRY_LIST_DEFINED') ) {
	define('COUNTRY_LIST_DEFINED', TRUE);

	function countryList ($popup_name, $javascript="") {
	...
	$country_list = array (
		...
		popup_menu($popup_name, $country_list, $javascript);
